...
public class SPUM_Manager : MonoBehaviour
{
    ...
    public UnitAniManager _unitObjSet;
    ...
    public void CheckPrefabVersionData()
    {
        if(Directory.Exists(unitPath))
        {
            ...
            foreach (FileInfo fileInfo in fileInf)
            {
                ...
                //데이터 싱크 부분
                UnitAniManager tST = prefab.GetComponent<UnitAniManager>();
    ...
    public void SavePrefabs()
    {
        if(_prefabUnitList.Count < _maxNumber)
        {
            ...
            UnitAniManager ttObjST = _unitObjSet.GetComponent<UnitAniManager>();
    ...
    public void OpenLoadData()
    {
        ...
        for ( var j = 0 ; j < _prefabUnitList.Count ; j++)
        {
            ...
            SPUM_SpriteList tObjST = tObj.GetComponent<UnitAniManager>()._spriteOBj;
            ...
            // 말 데이터가 있는지.
            if(tObj.GetComponent<UnitAniManager>()._horse)
            {
                ttObjST._objList[7].SetActive(true);

                string tPath = tObj.GetComponent<UnitAniManager>()._horseString;
    ...
    {
        UnitAniManager tPrefabST = _prefabUnitList[index].GetComponent<UnitAniManager>();
